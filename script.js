...
const popupProfileAdd = document.querySelector('.popup__profileAdd');
const popupCardAdd = document.querySelector('.popup__cardAdd');
...
const elementsListItem = document.querySelector('.elements__list-item');
...
const formAddProfile = document.querySelector('.form__add-profile');
